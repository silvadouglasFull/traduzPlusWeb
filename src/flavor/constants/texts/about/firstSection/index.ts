...
export const paragraphs: Array<Paragraph> = [
    ...
    },
    {
        id: 3,
        language: 'en',
        text: `Beyond traditional language services, we offer strategic, tailor-made consulting for both the Chinese and Brazilian markets, designed to align with each client’s specific objectives.
...
We turn insight into competitive advantage, building solid pathways for companies to engage intelligently, respectfully, and successfully within the Sino-Brazilian context.`
    },
    {
        id: 4,
        language: 'pt',
        text: `A Great Wall Language Solutions é uma provedora especializada em serviços linguísticos, com foco absoluto nas conexões entre o chinês mandarim, o português e o inglês. Nosso propósito é eliminar barreiras de comunicação entre culturas por meio de tradução profissional, interpretação e treinamento linguístico de excelência.

Nossa história começou de forma simples, porém significativa. Em 2012, passamos a oferecer serviços pontuais de interpretação para brasileiros e chineses que não conseguiam se comunicar entre si em negociações e encontros profissionais. Foi ali que percebemos algo essencial: existe um enorme vazio comunicacional entre Brasil e China — dois países com gigantesco potencial de cooperação econômica, mas ainda separados por barreiras linguísticas e culturais.
...
`,
    ...
    },
    {
        id: 5,
        language: 'pt',
        text: `Ao contrário de empresas que oferecem dezenas de idiomas com superficialidade, acreditamos que quem faz de tudo, não se aprofunda em nada. Por isso, escolhemos ser referência onde realmente importa: nas línguas que impulsionam negócios e relações entre o Brasil, a China e o mercado internacional.

Contamos com uma equipe de linguistas altamente qualificados, que viveram e estudaram na China, imersos na língua e na cultura, ouvindo, falando e interagindo com chineses todos os dias. Essa vivência proporciona uma compreensão profunda das sutilezas linguísticas e culturais — o tipo de percepção que faz toda a diferença em uma comunicação eficaz e respeitosa.
...
`
    },
    {
        id: 6,
        language: 'pt',
        text: `Além dos serviços linguísticos tradicionais, oferecemos uma consultoria estratégica e altamente especializada no mercado chinês e brasileiro, desenvolvida sob medida para atender aos objetivos específicos de cada cliente.
...
Transformamos informação em vantagem competitiva, criando pontes seguras para empresas que desejam atuar com inteligência, respeito e eficiência no contexto sino-brasileiro.`
    },
    {
        id: 7,
        language: 'zh',
        text: `长城语言解决方案公司是一家专注于中文普通话、葡萄牙语和英语的专业语言服务提供商。

我们的使命是通过专业翻译、口译和高质量语言培训，消除文化与语言之间的障碍。

我们的故事始于2012年，当时我们开始为巴西人与中国人之间因语言障碍而沟通受限的问题，提供现场口译服务。正是在这些实际交流中，我们意识到一个关键问题：巴西与中国之间存在着深层的沟通鸿沟，而两国却拥有巨大的合作潜力和经贸互补性。
...
`,
    ...
    },
    {
        id: 8,
        language: 'zh',
        text: `我们不同于那些提供几十种语言但缺乏深入专业能力的机构。我们始终坚信：“样样会，样样松”。因此，我们选择专注于真正推动中巴及国际合作的核心语言，并在这些领域内成为行业标杆。
